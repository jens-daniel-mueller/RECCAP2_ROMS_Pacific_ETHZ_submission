...
path_cmorized_annual <-
  "/net/kryo/work/loher/ROMS/RECCAP2_Jan2022/Pacific_global_proto_runA/submit_20220325/"
...
file <- paste(i_variable,
              "_ROMS-Pacific-ETHZ_1_gr_1980-2018_v20210707.nc",
              sep = "")
print(file)
...
for (i_variable in variables) {
  ...
  # read list of all files
  file <- paste(i_variable,
                "_ROMS-Pacific-ETHZ_1_gr_v20210707.nc",
                sep = "")
  print(file)
