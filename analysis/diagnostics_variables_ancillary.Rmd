...
path_cmorized_annual <-
  "/net/kryo/work/loher/ROMS/RECCAP2/Pactcs30_global_proto/submit_20210622/"
...
file <- paste(i_variable,
              "_ROMS-Pacific-ETHZ_1_gr_1980-2018_v20210622.nc",
              sep = "")
print(file)
...
for (i_variable in variables) {
  ...
  # read list of all files
  file <- paste(i_variable,
                "_ROMS-Pacific-ETHZ_1_gr_v20210622.nc",
                sep = "")
  print(file)
